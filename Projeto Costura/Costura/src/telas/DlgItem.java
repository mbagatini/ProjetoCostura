...
public class DlgItem extends javax.swing.JDialog {
    ...
    private GestorProdutos gestorproduto = new GestorProdutos();
    private String referencia;
    private boolean selecionado;

    public DlgItem(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        gestorproduto.popularTabela(tblProdutos, txtPesquisar.getText());
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        this.referencia = tblProdutos.getValueAt(tblProdutos.getSelectedRow(), 0).toString();
    ...
    private void limparTela() {
        ...
        this.gestorproduto.popularTabela(tblProdutos, this.txtPesquisar.getText());
