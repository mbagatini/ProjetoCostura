...
public class DlgCliente extends javax.swing.JDialog {
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        this.cliente = (Cliente) gestorcliente.consultarCod(Integer.parseInt(tblClientes.getValueAt(tblClientes.getSelectedRow(), 0).toString()));
    ...
    private void limparTela() {
        ...
        this.gestorcliente.popularTabela(tblClientes, this.txtPesquisar.getText());
