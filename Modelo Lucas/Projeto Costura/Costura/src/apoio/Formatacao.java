...
public class Formatacao {
    ...
    public static void formatarDecimal(JTextField campo) {
        campo.setText(df.format(Double.parseDouble(campo.getText().replace(",", "."))));
    }

    public static String formatarDecimal2(double valor) {
        NumberFormat formatter = new DecimalFormat("#,##0.00");
        return (formatter.format(valor));
    }
    
    public static double getDecimal(String valor){
        try {
